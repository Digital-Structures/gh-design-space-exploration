...
namespace JMetalRunners
{
	...
	/// Antonio J. Nebro, Juan Jos̩ Durillo, Carlos Artemio Coello Coello:
	...
	public class SMPSOhv
	{
		...
		///      - SMPSOhv
		///      - SMPSOhv problemName
		///      - SMPSOhv problemName ParetoFrontFile
		/// </summary>
		...
		public static void Main(string[] args)
		{
			...
			algorithm = new JMetalCSharp.Metaheuristics.SMPSO.SMPSOhv(problem);
