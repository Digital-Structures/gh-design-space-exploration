...
// Type: StructureEngine.Model.SquareSection
...
namespace StructureEngine.Model
{
  ...
  {
    public SquareSection(double p, string n)
    {
      this.SectionParameter = p;
      this.Name = n;
    }

    public SquareSection()
    {
      this.SectionParameter = 0.009525;
      this.Name = "RecPC";
    }

    public SectionType Type => SectionType.Square;
    ...
    {
      return 2.25 * Math.Pow(reqArea / this.SectionParameter / 2.0, 4.0);
    }

    public double GetReqMomInertiaY(double reqArea)
    {
      return Math.Pow(reqArea / this.SectionParameter, 4.0) / 12.0;
    }
    ...
    {
      return (ISection) new SquareSection(this.SectionParameter, this.Name);
    }
  }
}
