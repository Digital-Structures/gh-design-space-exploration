...
namespace netDxf
{
    ...
    public class StringEnum
    {
        ...
        private static readonly IDictionary<Enum, StringValueAttribute> stringValues = new Dictionary<Enum, StringValueAttribute>();
        ...
        public string GetStringValue(string valueName)
        {
            ...
            try
            {
               Enum type = (Enum) Enum.Parse(this.enumType, valueName, true);
        ...
        public static object Parse(Type type, string stringValue, bool ignoreCase)
        {
            ...
            foreach (FieldInfo fi in type.GetFields())
            {
                ...
                if (string.Compare(enumStringValue, stringValue, ignoreCase ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal) == 0)
                {
                    output = Enum.Parse(type, fi.Name, true);
                    break;
                }
            }
